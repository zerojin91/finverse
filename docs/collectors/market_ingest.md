...
`collectors/market_ingest.py` ingests Korean market data — indices, sector indices, listed stocks, and foreign/institutional investor flows — into the Finverse JSONL data lake. It covers the **시장** domain of the [FINVERSE ontology](../ontology/finverse-ontology.md).
