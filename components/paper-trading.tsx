  ...
  return (
    <div className="paper-coach" role="dialog" aria-label="모의 투자 사용 방법">
      <div className="paper-coach-card">
        ...
        <h3>{worldMode ? "실제 근거 위에서 시장을 함께 시뮬레이션합니다" : "한 번의 이벤트를 네 단계로 겪습니다"}</h3>
        {worldMode ? (
          <ol>
            <li><b>초기 세계 상태</b><p>시장·경제·사건·커뮤니티 실제 근거를 종합해 가격·수급·거시 환경·심리와 활성 모멘텀을 확정합니다.</p></li>
            <li><b>외부 환경과 사건</b><p>World Agent가 매 거래일 환경을 갱신합니다. 사건은 실제 유사 사례를 retrieval한 뒤 모멘텀·계절성·서프라이즈 규칙에 따라 전개됩니다.</p></li>
            <li><b>59개 독립 판단</b><p>개인 40·외국인 6·기관 12·연기금 1 에이전트가 서로의 주문을 보지 않고 각자 프로필·기억·공개 정보로 행동합니다.</p></li>
            <li><b>사용자 판단과 시장 체결</b><p>중요 사건은 사용자에게 먼저 공개됩니다. 주문·근거·확신도를 남기면 에이전트 주문과 함께 체결되고, 결과는 다음 거래일 환경에만 반영됩니다.</p></li>
            <li><b>회고</b><p>완료 후 수익률뿐 아니라 기록한 판단을 바탕으로 추격·손실 회피·과신·과매매 패턴을 돌아봅니다.</p></li>
          </ol>
        ) : (
        <ol>
