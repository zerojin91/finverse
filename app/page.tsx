  ...
  return (
    <main className="intro-smoke">
      ...
      <section className="intro-smoke-gap intro-smoke-wrap">
        <div className="intro-smoke-gap-heading"><div><span>계획과 실제</span><h2>알고 있는 것과<br />행동하는 것 사이</h2></div><b>BEHAVIOR GAP</b></div>
        ...
        <div className="intro-smoke-gap-punch"><span>FINVERSE가 다루는 것은 지식의 부족이 아닙니다.</span><strong>알면서도 지키기 어려웠던<br />그 순간을 다시 연습합니다.</strong></div>
      </section>
