...
GRANT USAGE ON SCHEMA lake, market, events TO finverse_read;
GRANT SELECT ON ALL TABLES IN SCHEMA lake, market, events TO finverse_read;
ALTER DEFAULT PRIVILEGES IN SCHEMA lake, market, events
...
GRANT ALL ON SCHEMA lake, market, events TO finverse_admin;
GRANT ALL ON ALL TABLES IN SCHEMA lake, market, events TO finverse_admin;
GRANT ALL ON ALL SEQUENCES IN SCHEMA lake TO finverse_admin;
ALTER DEFAULT PRIVILEGES IN SCHEMA lake, market, events GRANT ALL ON TABLES TO finverse_admin;
