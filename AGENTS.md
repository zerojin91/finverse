...
- 게임 화면의 차트는 실제 이력을 항상 최근 10거래일만 보이고, 선택한 1·10·20·60거래일 전체 폭은 미래 슬롯으로 미리 확보해 스크롤 없이 한 화면에 표시한다. 따라서 10거래일 연습은 과거 10일과 미래 10일을 1:1 폭으로 보여준다. 실제 이력도 양봉·음봉 색을 유지하되 투명도로 현재 시뮬레이션과 구분하며, 진행된 거래일만 오른쪽 슬롯을 채운다.
